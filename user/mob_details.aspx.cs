...
public partial class user_mob_details : System.Web.UI.Page
{
    ...
    {
        TextBox1.Text = (String)Session["mobile"];
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (d.dr.Read())
        {
            ...
            if (ramt < amt)
            {
                d.writedata("insert into user_transaction values('" + (String)Session["uname"] + "','Mobile'," + TextBox1.Text + ",'" + (String)Session["operator"] + "'," + TextBox2.Text + ",'" + System.DateTime.Now.ToShortDateString() + "','Pending')");
                ...
                Response.Write("<script>alert('Mobile Recharge Completed Successfully')</script>");
