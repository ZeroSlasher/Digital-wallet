...
<div class="banner">
	<div class="header">	
			<div class="logo">
			   <h1><a href="home.aspx"><i><img src="../images/cell.png" alt=" " /></i>DIGITAL WALLET</h1>
			</div>
			<div class="top-nav">
				...
				<ul class="nav1">
					...
					<li><a href="Datacard.aspx" >datacard</a></li>
					<li><a href="DTH.aspx" >DTH</a></li>
	...
	<div class="container">
		<div class="banner-info">
			<h3>One stop destination for all online paymets </h3>
		</div>
		<div class="buttons">
			<ul>
				<li ><a class="hvr-shutter-in-vertical" href="Mobile.aspx" >Mobile</a></li>
				<li><a class="hvr-shutter-in-vertical" href="DTH.aspx" >DTH</a></li>
				<li><a class="hvr-shutter-in-vertical" href="Datacard.aspx" >Datacard</a></li>
			</ul>
...
<div class="footer">
	<div class="container">
		<h2><a href="index.html">Digital Wallet</a></h2>
		<p>© 2017 Digital Wallet. All Rights Reserved | Designed by <a href="#" target="_blank">Rider</a></p>
		<ul>
												...
												<div class="tab-pane active" role="tabpanel" id="step1">
													<div class="mobile-grids">
														...
														<div class="mobile-right">
															...
															<label>+91</label> <asp:TextBox ID="txtmob" runat="server" CssClass="mobile-text" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '';}" required=""></asp:TextBox>
                                                            <!--<input type="text" class="mobile-text" value="" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '';}" required=""/> -->
													...
													<ul class="list-inline pull-right">
														 <asp:Button ID="next1" runat="server" CssClass="mob-btn btn btn-primary next-step" Text="NEXT" />
...
<%--                                                                                <asp:RadioButton ID="rbtnpre" runat="server" GroupName="a" Text="Prepaid" />--%>
																			<i></i>
																			</label> 
																		</div>
																	</div>
																	<div class="check_box"> 
																        ...
																        <asp:RadioButtonList ID="RadioButtonList3" runat="server">
                                                                               ...
                                                                               <%-- <asp:RadioButton ID="RadioButton1" runat="server" GroupName="a" Text="Prepaid" />--%>
																			<i></i>
																			</label> 
																		</div>
																	</div>
													...
													<ul class="list-inline pull-right">
                                                        <asp:Button ID="prev1" runat="server" CssClass="mob-btn btn btn-default prev-step" Text="PREVIOUS" />
                                                        <asp:Button ID="next2" runat="server" CssClass="mob-btn btn btn-primary next-step" Text="NEXT" />
											...
											<!--to complete-->
															...
															<div class="section_room">
                                                                   <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource1" DataTextField="oprtrname" DataValueField="oprtrname">
                                                                        <asp:ListItem>a</asp:ListItem>
                                                                    </asp:DropDownList>
                                                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Digital_wallet_String %>" SelectCommand="SELECT [oprtrname] FROM [moboprtr] ORDER BY [oprtrname]"></asp:SqlDataSource>
													...
													<ul class="list-inline pull-right">
                                                        <asp:Button ID="prev2" runat="server" CssClass="mob-btn btn btn-default prev-step" Text="Previous" />
                                                        <asp:Button ID="next3" runat="server" CssClass="mob-btn btn btn-primary btn-info-full next-step" Text="Next" />
                                                        <!--<li><button type="button" class="mob-btn btn btn-default prev-step">Previous</button></li>-->
												...
												<div class="tab-pane" role="tabpanel" id="step4">
													<div class="mobile-grids">
														...
														<div class="mobile-right ">
															...
															<div class="section_room">
                                                                                ...
                                                                                <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="SqlDataSource2" DataTextField="circle" DataValueField="circle">
                                                                                </asp:DropDownList>
                                                                                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Digital_wallet_String %>" SelectCommand="SELECT [circle] FROM [moboprtr] ORDER BY [circle]"></asp:SqlDataSource>
													...
													<ul class="list-inline pull-right">
                                                        <asp:Button ID="prev3" runat="server" CssClass="mob-btn btn btn-default prev-step" Text="Previous" />
                                                        <asp:Button ID="next4" runat="server" CssClass="mob-btn btn btn-primary btn-info-full next-step" Text="Next" />
														<!--<li><button type="button" class="mob-btn btn btn-default prev-step">Previous</button></li>
														<li><button type="button" class="mob-btn btn btn-primary btn-info-full next-step">Next</button></li>-->
													</ul>
												</div>
													...
													<div class="mobile-grids">
														...
														<div class="mobile-right ">
															...
															<div class="mobile-rchge">	
                                                                <asp:TextBox ID="txtamt" runat="server" CssClass="mobile-text" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '';}" required=""></asp:TextBox>				
                                                             <!--   <input type="text" value="10" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '10';}" required=""/>	-->
															</div>
															<div class="mobile-rchge">
                                                                 <asp:Button ID="viewmobpln" runat="server" CssClass="mob-btn btn btn-default prev-step" Text="view plans" />

										<!--to complete-->  <a href="single.html">VIEW PLANS</a>
															</div>
															<div class="clearfix"></div>
														</div>
													</div>
													<ul class="list-inline pull-right">
                                                        <asp:Button ID="prev4" runat="server" CssClass="mob-btn btn btn-default prev-step" Text="Previous" />
														<!--<li><button type="button" class="mob-btn btn btn-default prev-step">Previous</button></li>-->
                                                        <asp:Button ID="finish1" runat="server" CssClass="mob-btn btn btn-primary btn-info-full" data-dismiss="modal" Text="Go to payment" />
			...
			<div class="modal fade" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
				<!--to complete-->			<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>						
						</div>
						<div class="modal-body">
								<section>
									<div class="wizard">
										<div class="wizard-inner">
											...
											<div class="tab-content">
												<div class="tab-pane active" role="tabpanel" id="step6">
													...
													<ul class="list-inline pull-right">
                                                        <asp:Button ID="next11" runat="server" CssClass="mob-btn btn btn-primary next-step" Text="NEXT" />
														<!--<li><button type="button" class="mob-btn btn btn-primary next-step">Next</button></li>-->
													</ul>
												</div>
												<div class="tab-pane" role="tabpanel" id="step7">
													<div class="mobile-grids">
														...
														<div class="mobile-right">
															...
															<div class="dth-rchge">
                                                                <asp:TextBox ID="dthcrdno" runat="server" CssClass="mobile-text" valu="Enter Smart Card Number" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '';}" required=""></asp:TextBox>				
												...
												<div class="tab-pane" role="tabpanel" id="step10">
													<div class="mobile-grids">
														...
														<div class="mobile-right ">
															...
															<div class="section_room">
																<select id="Select3" onchange="change_country(this.value)" class="frm-field required">
												...
												<div class="tab-pane active" role="tabpanel" id="step12">
													<div class="mobile-grids">
														...
														<div class="mobile-right">
															...
															<div class="section_room">
																<select id="Select4" onchange="change_country(this.value)" class="frm-field required">
							...
							<div class="login-grids">
								<div class="login">
									...
									<div class="login-right">
                                        ...
                                        <input type="text" id="txtuname" runat="server" class="mobile-text"  onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Enter your mobile number';}" required="" />
                                         <input type="password" id="Txtpwd" runat="server" class="mobile-text"  onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}" required="" />
                                            <%--<asp:TextBox ID="txtuname" runat="server" CssClass="mobile-text"  onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Enter your mobile number';}" required=""></asp:TextBox>
                                            <asp:TextBox ID="Txtpwd" runat="server" CssClass="mobile-text"  onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}" required=""></asp:TextBox>	
                                        ...
                                        <%--<a href="signin.aspx" class="mob-btn btn btn-primary next-step">SIGN IN</a>--%>
                                            <asp:Button ID="signin" runat="server" OnClick="signin_click" CssClass="mob-btn btn btn-primary next-step" Text="signin"/>
															</div>
									<div class="clearfix"></div>								
								</div>
								<p><span>By logging in you agree to our n>Terms and Conditions</span> and <span>Privacy Policy</span></p>
							</div>
						</div>
					</div>
				</div>
