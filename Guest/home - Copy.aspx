<%@ Page Language="C#" AutoEventWireup="true" CodeFile="home - Copy.aspx.cs" Inherits="Guest_home" %>
...
<div class="banner">
	<div class="header">	
			<div class="logo">
			   <h1><a href="index.html"><i><img src="../images/cell.png" alt=" " /></i>DIGITAL WALLET</a></h1>
			</div>
			<div class="top-nav">
								...
								<div class="login">
									...
									<div class="login-right">
                                        ...
                                        <%--<a href="signin.aspx" class="mob-btn btn btn-primary next-step">SIGN IN</a>--%>
                                            <asp:Button ID="signin" runat="server" CssClass="mob-btn btn btn-primary next-step" Text="signin" PostBackUrl="~/Guest/signin.aspx"/>
															</div>
									<div class="clearfix"></div>								
								</div>
								<p>By logging in you agree to our n>Terms and Conditions</span> and <span>Privacy Policy</span></p>
							</div>
						</div>
					</div>
				</div>
